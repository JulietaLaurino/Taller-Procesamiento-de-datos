...
Podés descargarte los datos para seguir el tutorial en el siguiente link:
[datos](https://github.com/JulietaLaurino/gorilla-data-processing-with-R/tree/master/data)
